    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed_link', models.URLField(blank=True, default=b'', max_length=1000, null=True)),
                ('feed_link_locked', models.BooleanField(default=False)),
                ('hash_address_and_link', models.CharField(max_length=64, unique=True)),
                ('feed_title', models.CharField(blank=True, default=b'[Untitled]', max_length=255, null=True)),
